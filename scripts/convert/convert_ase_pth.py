...
ase_pth_path = 'runs/Humanoid_ep_18500_rew_1155.2125_18500.pth'
...
del model["a2c_network.actor_mlp._dense_layers.0.weight"]
del model["a2c_network.actor_mlp._dense_layers.0.bias"]
del model["a2c_network.actor_mlp._dense_layers.1.weight"]
del model["a2c_network.actor_mlp._dense_layers.1.bias"]
del model["a2c_network.actor_mlp._dense_layers.2.weight"]
del model["a2c_network.actor_mlp._dense_layers.2.bias"]
...
del model["a2c_network.critic_mlp._mlp.0.weight"]
del model["a2c_network.critic_mlp._mlp.0.bias"]
del model["a2c_network.critic_mlp._mlp.2.weight"]
del model["a2c_network.critic_mlp._mlp.2.bias"]
del model["a2c_network.critic_mlp._mlp.4.weight"]
del model["a2c_network.critic_mlp._mlp.4.bias"]
...
del model["a2c_network.actor_mlp._style_mlp.0.weight"]
del model["a2c_network.actor_mlp._style_mlp.0.bias"]
del model["a2c_network.actor_mlp._style_mlp.2.weight"]
del model["a2c_network.actor_mlp._style_mlp.2.bias"]
del model["a2c_network.actor_mlp._style_dense.weight"]
del model["a2c_network.actor_mlp._style_dense.bias"]
...
del model["a2c_network._disc_logits.weight"]
del model["a2c_network._disc_logits.bias"]
...
del model["a2c_network._enc.weight"]
del model["a2c_network._enc.bias"]
